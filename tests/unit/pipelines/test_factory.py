...
class TestCreateEvidencePipeline:
    ...
    def test_create_basic_evidence_pipeline(self, mock_pipeline_class, mock_config, test_db_path):
    ...
    @patch('src.pipelines.factory.EvidencePipeline')
    def test_create_adaptive_evidence_pipeline(self, mock_pipeline_class, mock_config, test_db_path):
    ...
    @patch('src.pipelines.factory.EvidencePipeline')
    def test_create_with_custom_config(self, mock_pipeline_class, mock_config, test_db_path):
...
class TestCreateByType:
    ...
    @patch('src.pipelines.factory.EvidencePipeline')
    def test_create_adaptive_evidence_type(self, mock_pipeline_class, mock_config, test_db_path):
...
class TestConfigurationConsistency:
    ...
    @patch('src.pipelines.factory.EvidencePipeline')
    def test_database_config_passed(self, mock_pipeline_class, mock_config, test_db_path):
    ...
    @patch('src.pipelines.factory.EvidencePipeline')
    def test_persistence_enabled_by_default(self, mock_pipeline_class, mock_config, test_db_path):
    ...
    @patch('src.pipelines.factory.EvidencePipeline')
    def test_expert_analysis_enabled(self, mock_pipeline_class, mock_config, test_db_path):
