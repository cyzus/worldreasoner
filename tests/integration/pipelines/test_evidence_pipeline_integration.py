...
@pytest.mark.asyncio
async def test_evidence_pipeline_quality_filtering(persistent_test_db_path, resolved_questions_with_scores):
    ...
    evidence_config = EvidencePipelineConfig(max_questions=10, skip_already_processed=False)
