...
class TestFilterByWindow:
    ...
    def test_filter_articles_within_window(self):
        ...
        articles = [
            Article(id="a1", title="Article 1", url="http://example.com/1",
                   published_date=datetime(2024, 3, 1, tzinfo=timezone.utc), content="Test 1"),
            Article(id="a2", title="Article 2", url="http://example.com/2",
                   published_date=datetime(2024, 4, 1, tzinfo=timezone.utc), content="Test 2"),
            Article(id="a3", title="Article 3", url="http://example.com/3",
                   published_date=datetime(2024, 5, 1, tzinfo=timezone.utc), content="Test 3"),
        ]
    ...
    def test_filter_articles_before_window_start(self):
        ...
        articles = [
            Article(id="a1", title="Article 1", url="http://example.com/1",
                   published_date=datetime(2024, 1, 1, tzinfo=timezone.utc), content="Test 1"),
            Article(id="a2", title="Article 2", url="http://example.com/2",
                   published_date=datetime(2024, 4, 1, tzinfo=timezone.utc), content="Test 2"),
        ]
    ...
    def test_filter_articles_at_or_after_window_end(self):
        ...
        articles = [
            Article(id="a1", title="Article 1", url="http://example.com/1",
                   published_date=datetime(2024, 4, 1, tzinfo=timezone.utc), content="Test 1"),
            Article(id="a2", title="Article 2", url="http://example.com/2",
                   published_date=datetime(2024, 6, 1, tzinfo=timezone.utc), content="Test 2"),  # Exactly at end
            Article(id="a3", title="Article 3", url="http://example.com/3",
                   published_date=datetime(2024, 7, 1, tzinfo=timezone.utc), content="Test 3"),  # After end
        ]
    ...
    def test_filter_with_none_window_start(self):
        ...
        articles = [
            Article(id="a1", title="Article 1", url="http://example.com/1",
                   published_date=datetime(2020, 1, 1, tzinfo=timezone.utc), content="Test 1"),
            Article(id="a2", title="Article 2", url="http://example.com/2",
                   published_date=datetime(2024, 4, 1, tzinfo=timezone.utc), content="Test 2"),
        ]
    ...
    def test_filter_events_by_occurred_date(self):
        ...
        events = [
            Event(id="e1", title="Event 1", description="Test 1",
                 occurred_date=datetime(2024, 3, 1, tzinfo=timezone.utc), domain=Domain.POLITICS),
            Event(id="e2", title="Event 2", description="Test 2",
                 occurred_date=datetime(2024, 5, 1, tzinfo=timezone.utc), domain=Domain.POLITICS),
        ]
    ...
    def test_filter_items_without_dates(self):
        ...
        articles = [
            Article(id="a1", title="Article 1", url="http://example.com/1",
                   published_date=None, content="Test 1"),
            Article(id="a2", title="Article 2", url="http://example.com/2",
                   published_date=datetime(2024, 4, 1, tzinfo=timezone.utc), content="Test 2"),
        ]
    ...
    def test_filter_articles_at_or_after_cutoff(self):
        ...
        articles = [
            Article(id="a1", title="Article 1", url="http://example.com/1",
                   published_date=datetime(2024, 4, 1, tzinfo=timezone.utc), content="Test 1"),
            Article(id="a2", title="Article 2", url="http://example.com/2",
                   published_date=datetime(2024, 5, 1, tzinfo=timezone.utc), content="Test 2"),  # Exactly at cutoff
            Article(id="a3", title="Article 3", url="http://example.com/3",
                   published_date=datetime(2024, 6, 1, tzinfo=timezone.utc), content="Test 3"),  # After cutoff
        ]
    ...
    def test_filter_events_by_cutoff(self):
        ...
        events = [
            Event(id="e1", title="Event 1", description="Test 1",
                 occurred_date=datetime(2024, 3, 1, tzinfo=timezone.utc), domain=Domain.POLITICS),
            Event(id="e2", title="Event 2", description="Test 2",
                 occurred_date=datetime(2024, 6, 1, tzinfo=timezone.utc), domain=Domain.POLITICS),
        ]
