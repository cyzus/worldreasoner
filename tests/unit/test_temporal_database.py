...
class TestGenericDatabaseTemporalFiltering:
    ...
    def populated_db(self, test_db_path, cutoff_date):
        ...
        articles = [
            Article(
                ...
                content="This article was published before the cutoff date. " * 5,  # > 100 chars
                source="Test",
            ...
            Article(
                ...
                content="This article was published exactly at the cutoff date. " * 5,  # > 100 chars
                source="Test",
            ...
            Article(
                ...
                content="This article was published after the cutoff date. " * 5,  # > 100 chars
                source="Test",
                published_date=cutoff_date + timedelta(days=1),
                domain="tech"
            ),
    ...
    def test_save_with_temporal_filtering(self, test_db_path, cutoff_date):
        ...
        article = Article(
            id="art_new",
            title="New Article",
            content="New content for testing temporal filtering behavior in the database layer with sufficient length. " * 2,  # > 100 chars
            source="Test",
