...
Return a summary when done.""",
    ...
    @staticmethod
    def format_article_summary(article: Article, idx: int) -> str:
        ...
        Returns:
            Formatted article summary
        """
        generator = EventIdentificationPrompts()
        return generator.format_item(article, idx)
    
    @staticmethod
    def get_identification_instruction(
        current_date: datetime,
        articles: List[Article],
        confidence_threshold: float
    ) -> str:
