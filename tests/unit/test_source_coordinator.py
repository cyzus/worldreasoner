...
async def test_collect_parallel_multiple_sources(sample_question):
    ...
    runner1.collect = AsyncMock(return_value=CollectionResult(
        source_name="source1",
        questions=[sample_question],
        requested_count=1,
        actual_count=1,
    ...
    runner2.collect = AsyncMock(return_value=CollectionResult(
        source_name="source2",
        questions=[sample_question],
        requested_count=1,
        actual_count=1,
...
async def test_collect_handles_exceptions_parallel():
    ...
    runner_ok.collect = AsyncMock(return_value=CollectionResult(
