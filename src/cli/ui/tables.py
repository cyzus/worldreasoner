...
def display_question_table(
    ...
    _display_table(questions, f"Questions ({len(questions)} total)", cols, get_row, console)
...
def display_article_table(articles: List[Article], console: Optional[Console] = None):
    ...
    _display_table(articles, f"Articles (showing {len(articles)})", cols, get_row, console)
