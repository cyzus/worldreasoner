...
def parse_cutoff_date(date_str: str) -> Optional[str]:
    ...
    pretraining_match = re.search(r'Pretraining\s+(\d{4}\.\d{2})', date_str, re.IGNORECASE)
...
def main():
    ...
    github_url = "https://github.com/HaoooWang/llm-knowledge-cutoff-dates/blob/main/README.md"
    ...
    print(f"✓ Successfully saved {data['metadata']['total_models']} models to {output_file}")
